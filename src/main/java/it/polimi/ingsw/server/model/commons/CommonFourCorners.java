...
public boolean check(Shelf shelf) {
    ...
    if(shelf.getItemByCoordinates(0, 0) != null &&
        ...
        return type == shelf.getItemByCoordinates(0, COLUMNS - 1).getColor()
                && type == shelf.getItemByCoordinates(ROWS - 1, COLUMNS - 1).getColor()
                && type == shelf.getItemByCoordinates(ROWS - 1, 0).getColor();
        } else {
            return false;
        }
    }
